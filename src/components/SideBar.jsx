            ...
            <div className="col col-2">
                ...
                >
                                ...
                                <ul className="p-0">
                                    <li>
                                        <a
                                            ...
                                            href="#"
                                        >
                                            <HouseDoorFill className="text-light"/>&nbsp; Home
                                        </a>
                                    </li>
                                    <li>
                                        <a
                                            ...
                                            href="#"
                                        >
                                            <CollectionFill className="text-light"/>&nbsp; Your Library
                                        </a>
                                    </li>
                                    <li>
                    ...
                    <div className="nav-btn w-100 d-flex flex-column align-items-center">
                        ...
                        <button className="btn login-btn border border-light" type="button">Login</button>
                        <div>
